...
$AllowedTypes = "gif|jpg|png|swf|doc|flv|pdf|xls";
//$AllowedTypes = "*";
...
?>
	...
	<?php
		...
		{		
	?>
			var object1="<?php echo $_GET['object1']?>";
			object2="<?php echo $_GET['object2']?>";
			...
			{
			    window.opener.document.getElementById(object2).src="resize.php?from=<?php echo pathPicture?>"+valuePath+"&w=50";
			}
