<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = $_SERVER["DOCUMENT_ROOT"].'/upimg/'.$_SESSION["login"].'/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"].'/upimg/'.$_SESSION["login"].'/'; // absolute or relative from this script path, required.
        ...
        // Upload options
        $mcImageManagerConfig['upload.maxsize'] = "4MB";
