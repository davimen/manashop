...
<tbody>
    ...
    <?php
    $rs_catmathang = $dbf->getDynamic("mathang_category", "status=1", "id asc ");
    $arraycategory = array();
    while ($rows_catmathang = $dbf->nextdata($rs_catmathang)) {
       $arraycategory[$rows_catmathang["id"]]=$rows_catmathang;
    }
    $stt_number = 1;
    ...
    <tr class="<?php echo (($stt_number % 2 == 0) ? "cell2" : "cell1") ?>">
          ...
          <td class="itemText" colspan="2"><b><i><?php echo $mathang_colum['item_name']; ?></i></b><br /><span style="color: red">(<?php echo $arraycategory[$mathang_colum["type_id"]]["title"]; ?>)</span></td>
