...
<div class="panelView" id="panelView">
    ...
    <center>
            ...
            <H1>THỐNG KẾ CHI TIẾT: THU NỢ TIỀN MẶT</H1>
...
<tbody>
    ...
    <?php
    $rs_hoadon = $dbf->getDynamic("hoadon", "((datecreated >= " . $tungay . " and datecreated <= " . $denngay . ") or (dateupdated >= " . $tungay . " and dateupdated <= " . $denngay . ")) and thanhtoan_id=11 and status=1", "id desc ");
    ...
    <tr class="<?php echo (($i % 2 == 0) ? "cell2" : "cell1") ?>">
      ...
      ?>
     <tr class="cell2">
       <td colspan='8' style="text-align: right"> Tiền mặt thu từ nợ là:</td>
       <td style="text-align: left; color: red;font-size:14px;"><b><?php echo $utl->format($tongsotienthongke_trano) ?> VNĐ</b></td>
     </tr>

     <tr class="cell2">
       <td colspan='8' style="text-align: right"> Tiền mặt trực tiếp:</td>
       <td style="text-align: left; color: red;font-size:14px;"><b><?php echo $utl->format($tongsotienthongke - $tongsotienthongke_trano) ?> VNĐ</b></td>
     </tr>
