...
<div class="panelAction" id="panelAction" style="height: 400px;">
   ...
   <div style="float: left; text-align: left; margin-top: 10px;">
       ...
       <legend style="color: #000080; padding-bottom: 10px"><b>Thống kê nhập kho phụ</b></legend>
...
$('#cmdSearch').click(function (){
    ...
    openBox('chitiet_nhapkho2.php?tungay='+tungay+'&denngay='+denngay+'&mathang_id='+mathang_id+'',792,650);
});
/*]]>*/
</script>