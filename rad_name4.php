...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KẾ CHI TIẾT: ĐẶT CỌC</H1>
...
<tbody>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and thanhtoan_id=8 and status=1","datecreated asc ");
    ...
    <tr class="<?php echo (($i%2==0)?"cell2":"cell1")?>">
       ...
       ?>
       <tr class="cell2">
        <td colspan="3">Tổng tiền đặt cọc</td>
        <td style="text-align: left; color: red;font-size:14px;"><b><?php echo $utl->format($tongsotienthongke_datcoc)?></b></td>

        <td colspan="2">Tổng tiền Còn lại</td>
        <td style="text-align: left; color: red;font-size:14px;"><b><?php echo $utl->format($tongsotienthongke-$tongsotienthongke_datcoc)?></b></td>

        <td style="text-align: right"> Tổng số tiền:</td>
    ...
    ?>
     ...
     <tr class="cell2">
        ...
        <td colspan="2" style="text-align: left; color: red;font-size:14px;"><b><?php echo $utl->format($tongsotienthongke_datcoc_all)?> VNĐ</b></td>
     </tr>

         <script>
            var price_total_lab = "<?php echo $utl->format($tongsotienthongke_datcoc_all); ?>";
